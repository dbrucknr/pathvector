...
mod tests {
    ...
    fn test_ipv4_unicast_roundtrip() {
        let msg = RouteRefreshMessage { afi_safi: AfiSafi::IPV4_UNICAST };
        assert_eq!(roundtrip(&msg), msg);
    }

    #[test]
    fn test_ipv6_unicast_roundtrip() {
        let msg = RouteRefreshMessage { afi_safi: AfiSafi::IPV6_UNICAST };
        assert_eq!(roundtrip(&msg), msg);
    }

    #[test]
    fn test_evpn_roundtrip() {
        let msg = RouteRefreshMessage { afi_safi: AfiSafi::EVPN };
        assert_eq!(roundtrip(&msg), msg);
    }
