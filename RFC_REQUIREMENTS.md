...
| RFC 4271 §8 | BGP Finite State Machine | pathvector-session, pathvectord | ⚠️ | [session](pathvector-session/RFC.md#rfc-4271-8--bgp-finite-state-machine) · [daemon](pathvectord/RFC.md#rfc-4271-8--connection-collision-coordination) — connection collision resolution has an inverted BGP-ID comparison + missing Cease NOTIFICATION, found by `RFC_AUDIT.md` 2026-07-16; core FSM itself remains solid |
...
| RFC 4724 | Graceful Restart | pathvector-session, pathvector-rib, pathvectord | ⚠️ | [session](pathvector-session/RFC.md#rfc-4724--graceful-restart-mechanism-for-bgp) · [daemon](pathvectord/RFC.md#rfc-4724--end-of-rib-marker-graceful-restart-helper--speaker-roles) — Receiving Speaker role (§4.2) is solid and e2e-tested; Restarting Speaker's own deferred route selection (§4.1) and the §5 FSM collision-override for GR peers are unimplemented, and duplicate-capability handling uses first-instance instead of RFC-mandated last-instance, found by `RFC_AUDIT.md` 2026-07-16 |
...
| RFC 7606 | Revised Error Handling for UPDATE | pathvector-session, pathvectord | ⚠️ | [session](pathvector-session/RFC.md#rfc-7606--revised-error-handling-for-bgp-update-messages) — missing well-known mandatory attribute triggers session-reset instead of the RFC-mandated treat-as-withdraw (highest-severity finding of the whole audit, easily triggered in ordinary operation), and duplicate-attribute handling is wrong for both MP_REACH/UNREACH_NLRI (too lenient) and ordinary attributes (too strict), found by `RFC_AUDIT.md` 2026-07-16 |
...
| RFC 6810 | RPKI-to-Router Protocol v0 (RTR) | pathvector-rpki | ⚠️ | [rpki](pathvector-rpki/RFC.md#rfc-6810--the-rpki-to-router-protocol-version-0) — Error Code 2 (non-fatal "No Data Available") not distinguished from fatal error codes, found by `RFC_AUDIT.md` 2026-07-16 |
| RFC 6811 | BGP Prefix Origin Validation (ROV) | pathvector-rpki, pathvector-policy, pathvectord | ⚠️ | [rpki](pathvector-rpki/RFC.md#rfc-6811--bgp-prefix-origin-validation) — Route Origin ASN derivation doesn't apply the RFC's substitution rule for AS_PATHs ending in a confederation segment, found by `RFC_AUDIT.md` 2026-07-16 |
...
| RFC 8210 | RPKI-to-Router Protocol v1 (RTR) | pathvector-rpki | ⚠️ | [rpki](pathvector-rpki/RFC.md#rfc-8210--the-rpki-to-router-protocol-version-1) — Error Code 2 (non-fatal "No Data Available") not distinguished from fatal error codes, found by `RFC_AUDIT.md` 2026-07-16 |
...
| RFC 9234 | BGP Route Leak Prevention Using Roles | pathvector-session, pathvector-rib, pathvector-policy, pathvectord | ⚠️ | [session](pathvector-session/RFC.md#rfc-9234--route-leak-prevention-using-roles-in-update-and-open-messages) · [rib](pathvector-rib/RFC.md#rfc-9234--route-leak-prevention-using-roles-in-update-and-open-messages) · [policy](pathvector-policy/RFC.md#rfc-9234--route-leak-prevention-using-roles-in-update-and-open-messages) · [daemon](pathvectord/RFC.md#rfc-9234--route-leak-prevention-using-roles-in-update-and-open-messages) — OTC leak-detection/propagation logic itself is solid; malformed-length OTC uses the wrong RFC 7606 policy (AttributeDiscard instead of mandated TreatAsWithdraw) and duplicate/conflicting peer Role Capabilities aren't detected, found by `RFC_AUDIT.md` 2026-07-16 |
